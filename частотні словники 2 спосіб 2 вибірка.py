...
with open("вибірка 2.txt",  encoding = "utf-8") as data_1:
...
#python -m PyQt5.uic.pyuic -x freq dict interface.ui -o freq dict interface.py
#C:\Users\Lenovo\AppData\Roaming\Python\Python37\site-packages\PyQt5\uic\pyuic -x freq dict interface.ui -o freq dict
# interface.py
